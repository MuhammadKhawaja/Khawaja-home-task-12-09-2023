...
var mixedArray = [1, "Suzuki", true , false, 1.15]
...
document.write("<h2>Qualifications...</h2>" , qualifications [0] + "<br>" + qualifications [1] + "<br>" + qualifications [2] + "<br>" + qualifications [3] + "<br>" + qualifications [4] + "<br>" + qualifications [5] + "<br>" + qualifications[6] + "<br>" + qualifications [7]);
